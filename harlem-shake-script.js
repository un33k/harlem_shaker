/* Harlem Shaker https://github.com/moovweb/harlem_shaker */
...
function harlemShake() {
    ...
    var PATH_TO_SONG = asset_base_url + "common/harlem_shake/harlem-shake.ogg";
    var PATH_TO_CSS = asset_base_url + "common/harlem_shake/harlem-shake-style.css";
    ...
    var allNodes = document.getElementsByTagName("*"),
        len = allNodes.length,
        i, thisNode;
    var firstNode = document.getElementById("id_harlemshake");
